...
-- custom control for external SynthDef
    ...
    pregain = pF "pregain"
    --
    modPhaseAmt = pF "modPhaseAmt"
    modPhaseAtk = pF "modPhaseAtk"
    modPhaseRls = pF "modPhaseRls"
    modPhaseCrv = pF "modPhaseCrv"
    delaySin = pF "delaySin"
    clickMix = pF "clickMix"
    noiseDec = pF "noiseDec"
    leak = pF "leak"
    distoMix = pF "distoMix"
    eqMix = pF "eqMix"
    --
    rngDelStn = pF "rngDelStn"
    rngStn = pF "rngStn"
    decaytimea = pF "decaytimea"
    fxMix = pF "fxMix"
    --
    sinAtn = pF "sinAtn"
    sinAtk = pF "sinAtk"
    sinRls = pF "sinRls"
    ringzMix = pF "ringzMix"
    ringzDcy = pF "ringzDcy"
    ringzDur = pF "ringzDur"
    ringzAtk = pF "ringzAtk"
    ringzRls = pF "ringzRls"
    --
    envmodLev1 = pF "envmodLev1"
    envmodLev2 = pF "envmodLev2"
    envmodLev3 = pF "envmodLev3"
    envmodLev4 = pF "envmodLev4"
    envmodLev = pF "envmodLev"
    envmodTime1 = pF "envmodTime1"
    envmodTime2 = pF "envmodTime2"
    envmodTime3 = pF "envmodTime3"
    envmodTime = pF "envmodTime"
    envmodCurve = pF "envmodCurve"
    fxFreqOffset = pF "fxFreqOffset"
    --
    envmodLev5 = pF "envmodLev5"
    envmodTime4 = pF "envmodTime4"
    noisePow = pF "noisePow"
    comb1 = pF "comb1"
    comb2 = pF "comb2"
    comb3 = pF "comb3"
    combDcy = pF "combDcy"
    freqShift3 = pF "freqShift3"
    freqShift2Mix = pF "freqShift2Mix"
    lpfEnd = pF "lpfEnd"
    lpfSwTime = pF "lpfSwTime"
    reverbMix = pF "reverbMix"
    --
    envmodCurve1 = pF "envmodCurve1"
    envmodCurve2 = pF "envmodCurve2"
    envmodCurve3 =  pF "envmodCurve3"
    freqSwTime = pF "freqSwTime"
    inPow = pF "inPow"
    reso = pF "reso"
    noiseFiltFreq = pF "noiseFiltFreq"
    noiseDur = pF "noiseDur"
    ringzAmp = pF "ringzAmp"
    --
    phasorDir = pF "phasorDir"
    phasorInv = pF "phasorInv"
    phasorRate1 = pF "phasorRate1"
    phasorRate2 = pF "phasorRate2"
    envmodAtk = pF "envmodAtk"
    envmodRls = pF "envmodRls"
    envmodCrv = pF "envmodCrv"
    noiseamt = pF "noiseamt"
    parLag = pF "parLag"
    parDecay = pF "parDecay"
    snapAmt = pF "snapAmt"
    hiShelfFreq = pF "hiShelfFreq"
    hiShelfSlope = pF "hiShelfSlope"
    hiShelfDb = pF "hiShelfDb"
    membrane2Amt = pF "membrane2Amt"
    --
    modamt = pF "modamt"
    freqMaxFactor = pF "freqMaxFactor"
    inPow1 = pF "inPow1"
    inPreGain = pF "inPreGain"
    res1 = pF "res1"
    overdrive = pF "overdrive"
    type1 = pF "type1"
    selFilter = pF "selFilter"
    inPow2 = pF "inPow2"
    res2 = pF "res2"
    type2 = pF "type2"
    strMix = pF "strMix"
    strthreshold = pF "strthreshold"
    strdur = pF "strdur"
    structpow = pF "structpow"
    brightness = pF "brightness"
    filtMix = pF "filtMix"
    --
    modFb = pF "modFb"
    controlScaleFact = pF "controlScaleFact"
    envFolAtk = pF "envFolAtk"
    envFolRls = pF "envFolRls"
    noiseAmt = pF "noiseAmt"
    noiseFact = pF "noiseFact"
    lpgVcaModPow = pF "lpgVcaModPow"
    feedbackAmt = pF "feedbackAmt"
    feedbackHpf = pF "feedbackHpf"
    --
    ratioOffset = pF "ratioOffset"
    foldTreshold = pF "foldTreshold"
    formantAmt = pF "formantAmt"
    formantatk = pF "formantatk"
    formantRls = pF "formantRls"
    formantCrv = pF "formantCrv"
    formantCarrFreqMin = pF "formantCarrFreqMin"
    formantCarrFreqMax = pF "formantCarrFreqMax"
    formantLag = pF "formantLag"
    sinAmt = pF "sinAmt"
    sinCrv = pF "sinCrv"
    filterLag = pF "filterLag"
    revEarlyRefLev = pF "revEarlyRefLev"
    revTailLev = pF "revTailLev"
    --
    mod1Rate = pF "mod1Rate"
    mod2Rate = pF "mod2Rate"
    envmodCircleTime = pF "envmodCircleTime"
    modSel = pF "modSel"
    numdatapoints = pF "numdatapoints"
    maxnummeans = pF "maxnummeans"
    nummeans = pF "nummeans"
    tnewdata = pF "tnewdata"
    tnewmeansModAmt = pF "tnewmeansModAmt"
    soft = pF "soft"
    pulseWidth = pF "pulseWidth"
    pulseLag = pF "pulseLag"
    --
    sinOctDown = pF "sinOctDown"
    sinDecay = pF "sinDecay"
    sinhpf = pF "sinhpf"
    textureAtk = pF "textureAtk"
    textureRls = pF "textureRls"
    textureFreq = pF "textureFreq"
    textureDisto = pF "textureDisto"
    textureFfreqOffset = pF "textureFfreqOffset"
    textureRq = pF "textureRq"
    texturehpf = pF "texturehpf"
    flterFreqModRate = pF "flterFreqModRate"
    filterFreqModAmt = pF "filterFreqModAmt"
    revRt60 = pF "revRt60"
    revlowFreq = pF "revlowFreq"
    revlowRatio = pF "revlowRatio"
    revhiFreq = pF "revhiFreq"
    revhiRatio = pF "revhiRatio"
    revearlyDiffusion = pF "revearlyDiffusion"
    revlateDiffusion = pF "revlateDiffusion"
    revmodRate = pF "revmodRate"
    revmodDepth = pF "revmodDepth"
    textureAmp = pF "textureAmp"
    --
    formantDecay = pF "formantDecay"
    threshold = pF "threshold"
    noiseFiltFreqMin = pF "noiseFiltFreqMin"
    noiseFiltFreqMax = pF "noiseFiltFreqMax"
    noiseDecay = pF "noiseDecay"
    clickRes = pF "clickRes"
    softsatAtk = pF "softsatAtk"
    softsatRls = pF "softsatRls"
    formantAmp = pF "formantAmp"
    softsatAmp = pF "softsatAmp"
    --
    mod1Atk = pF "mod1Atk"
    mod1Rls = pF "mod1Rls"
    mod1Crv = pF "mod1Crv"
    mod1CircleTime = pF "mod1CircleTime"
    mod2Threshold = pF "mod2Threshold"
    mod2LagTime = pF "mod2LagTime"
    modFold = pF "modFold"
    sinFreqModAmt = pF "sinFreqModAmt"
    sinFreqModCrv = pF "sinFreqModCrv"
    pulseDur = pF "pulseDur"
    distSel = pF "distSel"
    lowShelfFreq = pF "lowShelfFreq"
    lowShelfSlope = pF "lowShelfSlope"
    lowshelfDb = pF "lowshelfDb"
    clickDb = pF "clickDb"
    clickModAmt = pF "clickModAmt"
    subDb = pF "subDb"
    subFreqModDur = pF "subFreqModDur"
    --
    mod1Start = pF "mod1Start"
    mod1End = pF "mod1End"
    mod1Dur = pF "mod1Dur"
    mod2Start = pF "mod2Start"
    mod2End = pF "mod2End"
    mod2Dur = pF "mod2Dur"
    hiShelfSlope1 = pF "hiShelfSlope1"
    hiShelfSlope2 = pF "hiShelfSlope2"
    hiShelfGain = pF "hiShelfGain"
    filterFreqModSel = pF "filterFreqModSel"
    --
    revLpfFreq = pF "revLpfFreq"
    preDecay = pF "preDecay"
    bandfreq = pF "bandfreq"
    bandrq = pF "bandrq"
    banddb = pF "banddb"
    --
    noiseThr = pF "noiseThr"
    resoFreq1 = pF "resoFreq1"
    resoFreq2 = pF "resoFreq2"
    resoFreq3 = pF "resoFreq3"
    resoFreq4 = pF "resoFreq4"
    resoRingT1 = pF "resoRingT1"
    resoRingT2 = pF "resoRingT2"
    resoRingT3 = pF "resoRingT3"
    resoRingT4 = pF "resoRingT4"
    --
    freqMod = pF "freqMod"
    bodyPunch = pF "bodyPunch"
    bodyCore = pF "bodyCore"
    bodyCoreAtk = pF "bodyCoreAtk"
    bodyNoiseFreq = pF "bodyNoiseFreq"
    bodyNoiseRes = pF "bodyNoiseRes"
    bodyNoiseAmp = pF "bodyNoiseAmp"
    bodyDistSel = pF "bodyDistSel"
    clickFreqMax = pF "clickFreqMax"
    --
    envmodCurve4 = pF "envmodCurve4"
    pulseFreqInterval = pF "pulseFreqInterval"
    pulseAtk = pF "pulseAtk"
    pulseCrv = pF "pulseCrv"
    sinFreqInterval = pF "sinFreqInterval"
    sinFreqDiv = pF "sinFreqDiv"
    distoSel = pF "distoSel"
    filterModFreq = pF "filterModFreq"
    filterModAmt = pF "filterModAmt"
    --
    trigsSiseFact = pF "trigsSiseFact"
    density = pF "density"
    noiseSelThreshold = pF "noiseSelThreshold"
    rezoFreqsLag = pF "rezoFreqsLag"
    hiShelfRs = pF "hiShelfRs"
    onePoleMix = pF "onePoleMix"
    onePoleCoef = pF "onePoleCoef"
    distoPreGain = pF "distoPreGain"
    envGrainAtk = pF "envGrainAtk"
    envGrainDcy = pF "envGrainDcy"
    envGrainStn = pF "envGrainStn"
    envGrainRls = pF "envGrainRls"
    --
    lpgVca = pF "lpgVca"
    lpgVcaDur = pF "lpgVcaDur"
    lpgRes = pF "lpgRes"
    lpgRls = pF "lpgRls"
    lpgCrv = pF "lpgCrv"
    --
    mod1Phase = pF "mod1Phase"
    mod2Sart = pF "mod2Sart"
    ladderFreqModStart = pF "ladderFreqModStart"
    ladderFreqModEnd = pF "ladderFreqModEnd"
    ladderFreqModCrv = pF "ladderFreqModCrv"
    ladderFreqModDur = pF "ladderFreqModDur"
    ladderRes = pF "ladderRes"
    ladderOd = pF "ladderOd"
    distoAmt = pF "distoAmt"
    eq1Rq = pF "eq1Rq"
    eq1Db = pF "eq1Db"
    eq2Rq = pF "eq2Rq"
    eq2Db = pF "eq2Db"
    eq3Rq = pF "eq3Rq"
    eq3Db = pF "eq3Db"
    analogAmt = pF "analogAmt"
    transFuncSel = pF "transFuncSel"
    hpfFinalFreq = pF "hpfFinalFreq"
    sinFinalHpf = pF "sinFinalHpf"
    --
    envmodLev6 = pF "envmodLev6"
    envmodTime5 = pF "envmodTime5"
    combSwTime = pF "combSwTime"
    crossoverFreq = pF "crossoverFreq"
    snapShape = pF "snapShape"
    snapSel = pF "snapSel"
    snapPow = pF "snapPow"
    --
    mod1LevScale = pF "mod1LevScale"
    mod1TimeScale = pF "mod1TimeScale"
    mod1Lag = pF "mod1Lag"
    invMod1 = pF "invMod1"
    mod2LevScale = pF "mod2LevScale"
    mod2Lag = pF "mod2Lag"
    mod2Fold = pF "mod2Fold"
    invMod2 = pF "invMod2"
    pulseWidthOffset = pF "pulseWidthOffset"
    tremoloRate = pF "tremoloRate"
    tremoloHold = pF "tremoloHold"
    tremoloAtk = pF "tremoloAtk"
    tremoloRls = pF "tremoloRls"
    fxEnvFolAtk = pF "fxEnvFolAtk"
    fxEnvFolRls = pF "fxEnvFolRls"
    fxLag = pF "fxLag"
    allPassTrh = pF "allPassTrh"
    fShiftDb = pF "fShiftDb"
    allPassDb = pF "allPassDb"
    --
    sinFreqAtk = pF "sinFreqAtk"
    sinFreqRls = pF "sinFreqRls"
    sinFreqCrv = pF "sinFreqCrv"
    pulseModPow = pF "pulseModPow"
